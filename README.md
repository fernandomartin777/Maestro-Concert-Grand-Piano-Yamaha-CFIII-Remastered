...
This version is a fork from kinwie's project. Samples were normalized and other functions were added using the same samples. realistic simulated sympathetic resonance that responds to half and full sustain pedal, simulated soft pedal with and without resonances and round robins generated from adjacent keys,
